    ...
    <div className='xl:h-screen pb-4 xl:pb-0 px-10 pt-24 rounded-br-lg rounded-bl-lg' style={{backgroundImage:"url('./background.jpeg')"}}>
        <div className='flex justify-center'>
          <div className='sm:w-[70%] w-[90%] rounded-lg sm:mt-10 text-center'>
            ...
            <h1 className='text-white text-center poppins-medium  text-4xl mt-2 sm:mt-0 sm:text-6xl leading-[50px] sm:leading-[80px]'> <span className='bg-red-600 px-4 rounded-md '>FİKRİ MÜLKİYET</span> İHLALLERİNE SON!</h1>
            ...
            <a href="https://panel.safeastr.com/register" target='_blank' className='bg-white sm:px-14 px-4 py-2 sm:py-3 inline-block rounded-md mt-6 poppins-medium text-black text-lg border hover:bg-transparent hover:text-white duration-200'>Kayıt Ol</a>
            <Link to="/randevu-al" className='bg-white sm:px-14 px-4 py-2 sm:py-3 rounded-md ml-8 mt-6 poppins-medium text-black text-lg border hover:bg-transparent hover:text-white duration-200'>Randevu Al</Link>
          </div>
        </div>
